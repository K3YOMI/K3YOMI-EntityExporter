...
function requestMaps()
    TriggerServerEvent("K3YOMI:Client:RequestMaps")
end
...
RegisterNetEvent("K3YOMI:Server:RequestMapsRecieved") -- This is the event that will be called when the client requests the maps
AddEventHandler("K3YOMI:Server:RequestMapsRecieved", function(_data)
